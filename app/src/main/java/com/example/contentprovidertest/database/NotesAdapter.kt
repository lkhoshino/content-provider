package com.example.contentprovidertest.database
...
import com.example.contentprovidertest.NoteClickedListener
import com.example.contentprovidertest.R
import com.example.contentprovidertest.database.NotesDatabaseHelper.Companion.DESCRIPTION_NOTES
import com.example.contentprovidertest.database.NotesDatabaseHelper.Companion.TITLE_NOTES
...
class NotesAdapter(private val listener:NoteClickedListener):RecyclerView.Adapter<NotesViewHolder>(){
    ...
    override fun onBindViewHolder(holder: NotesViewHolder, position: Int) {
        ...
        holder.noteButtonRemove.setOnClickListener{
            mCursor?.moveToPosition(position)
            listener.noteRemovedItem(mCursor)
